            ...
            <div class="row clearfix">
                ...
                <div class="ctrl">
                    <input type="text" id="userid" name="userid" data-required="true" data-validation="text"
                        style="width:50%;" placeholder="请输入3-20为数字或字母"/>@365.com
                </div>
            </div>
           <div class="row clearfix">
                <div class="lbl">
			...
			<div class="row clearfix">
                ...
                <div class="ctrl">
                    <input type="password" id="repassword" name="repassword" style="width:90%;height:32px;border:1px solid rgb(225,225,225)"/>
                </div>
            </div>
            <script>
            	function goToLogin(){
