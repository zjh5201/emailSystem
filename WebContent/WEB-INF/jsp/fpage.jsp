...
<body class="bounceIn animated">
    <section id="getintouch" class="rotateInUpLeft animated">
        ...
        <c:if test="${success ne null }">
        	<p style="font-size:14px;color:red;">${success }</p>
        	<a style="font-size:14px;" href="${pageContext.request.contextPath }/login">回首页</a>
        </c:if>
        <form class="contact" action="/emailSys/user/editPwd/${user.userid }" method="POST" id="form">
           	<div class="row clearfix">
                ...
                <div class="ctrl">
                    <input type="text" id="name" name="userid" data-required="true" data-validation="text"
                        data-msg="Invalid Name" style="width:50%;" value="${user.userid }" placeholder="请填写您的账号" readonly="readonly">
                </div>
            </div>
            <div class="row clearfix">
                <div class="lbl">
                ...
                <div class="ctrl">
                    <input type="password" id="name" name="password" data-required="true" data-validation="text"  style="width:93%;height:32px;border:1px solid rgb(225,225,225)"
                        data-msg="Invalid Name" style="width:93%;">
                </div>
            </div>
            <div class="row clearfix">
                <div class="lbl">
                ...
                <div class="ctrl">
                    <input type="password" id="password" name="repassword"  style="width:93%;height:32px;border:1px solid rgb(225,225,225)"
                    >
                </div>
            </div>
            <div class="row  clearfix">
